...
class ManageAdminsController extends Controller{
    ...
    public function UpdateEnabled(Request $request, $pageNumber, $id){
        ...
        if(!$admin){
            ...
            $technicalIssuesRepo->addTechnicalIssue($user->getAdminId(), 'multiple', 'events', "Admin not found.", $request->getClientIp());
        ...
        $systemLogRepo->addSystemLog($user->getAdminId(), $id, 'admin_users', 'Update', $request->getClientIp());

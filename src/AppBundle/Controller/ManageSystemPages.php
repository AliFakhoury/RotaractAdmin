...
class ManageSystemPages extends Controller {
    /**
     * @Route("Admin/ManageSystemPages", name="ManageSystemPages")
     */
    ...
    /**
     * @Route("/Admin/ManageSystemPages/delete/{id}" , name="DeleteSystemPage")
     */
    public function DeleteSystemPage(Request $request,$id){
        $session = new Session();

...
class EditSystemPage extends  Controller{
    /**
     * @Route("/Admin/ManageSystemPages/EditPage/{id}",name="EditSystemPage")
     */
    public function EditSystemPageAction(Request $request, $id){
        $session = new Session();
        ...
        if($form->isSubmitted() && $form->isValid()){
            ...
            $systemLogRepo->addSystemLog($user->getAdminId(), $id, 'SystemPages', 'Edit', $request->getClientIp());
